...
**Pending changes:** _(none)_ — `openspec/changes/` має лише `archive/` subdirectory; start a new change to add work. Усі три плани з 2026-05-24 (`audit-followup-2026` + `signal-cli-protocol-alignment` + `deprecated-shim-removal`) merged + archived; див. список вище у "Implemented, merged, archived".
